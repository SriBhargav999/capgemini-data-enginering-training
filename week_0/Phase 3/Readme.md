...
**Challenges**
  ...
  - Dealing with missing and inconsistent data without affecting the final results
  - Writing correct join conditions when combining multiple datasets
  - Ensuring aggregations like sum and count were applied correctly after joins
__________________________________________________________________________________________________________________________
**Learnings:**
